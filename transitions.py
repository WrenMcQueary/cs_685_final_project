...
def get_angles_along_trajectory(num_inbetweeners: float, theta_0_i: float, theta_1_i: float, theta_2_i: float, theta_0_f: float, theta_1_f: float, theta_2_f: float) -> list:
    ...
    return [theta_0_inb, theta_1_inb, theta_2_inb]
