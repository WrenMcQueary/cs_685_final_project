...
(cl:defmethod cl:initialize-instance :after ((m <GripperStatus-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GripperStatus-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mira_communication-srv:<GripperStatus-request> is deprecated: use mira_communication-srv:GripperStatus-request instead.")))

(cl:ensure-generic-function 'Status-val :lambda-list '(m))
(cl:defmethod Status-val ((m <GripperStatus-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mira_communication-srv:Status-val is deprecated.  Use mira_communication-srv:Status instead.")
  (Status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GripperStatus-request>)))
  ...
  "mira_communication/GripperStatusRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GripperStatus-request)))
  "Returns string type for a service object of type 'GripperStatus-request"
  "mira_communication/GripperStatusRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GripperStatus-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GripperStatus-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mira_communication-srv:<GripperStatus-response> is deprecated: use mira_communication-srv:GripperStatus-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GripperStatus-response>)))
  ...
  "mira_communication/GripperStatusResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GripperStatus-response)))
  "Returns string type for a service object of type 'GripperStatus-response"
  "mira_communication/GripperStatusResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GripperStatus)))
  ...
  "mira_communication/GripperStatus")