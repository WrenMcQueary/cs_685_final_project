...
(cl:defmethod cl:initialize-instance :after ((m <SetAngles-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAngles-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mira_communication-srv:<SetAngles-request> is deprecated: use mira_communication-srv:SetAngles-request instead.")))

(cl:ensure-generic-function 'joint_1-val :lambda-list '(m))
(cl:defmethod joint_1-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mira_communication-srv:joint_1-val is deprecated.  Use mira_communication-srv:joint_1 instead.")
  (joint_1 m))

(cl:ensure-generic-function 'joint_2-val :lambda-list '(m))
(cl:defmethod joint_2-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mira_communication-srv:joint_2-val is deprecated.  Use mira_communication-srv:joint_2 instead.")
  (joint_2 m))

(cl:ensure-generic-function 'joint_3-val :lambda-list '(m))
(cl:defmethod joint_3-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mira_communication-srv:joint_3-val is deprecated.  Use mira_communication-srv:joint_3 instead.")
  (joint_3 m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mira_communication-srv:speed-val is deprecated.  Use mira_communication-srv:speed instead.")
  (speed m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetAngles-request>)))
  ...
  "mira_communication/SetAnglesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetAngles-request)))
  "Returns string type for a service object of type 'SetAngles-request"
  "mira_communication/SetAnglesRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetAngles-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAngles-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mira_communication-srv:<SetAngles-response> is deprecated: use mira_communication-srv:SetAngles-response instead.")))

(cl:ensure-generic-function 'Flag-val :lambda-list '(m))
(cl:defmethod Flag-val ((m <SetAngles-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mira_communication-srv:Flag-val is deprecated.  Use mira_communication-srv:Flag instead.")
  (Flag m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetAngles-response>)))
  ...
  "mira_communication/SetAnglesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetAngles-response)))
  "Returns string type for a service object of type 'SetAngles-response"
  "mira_communication/SetAnglesResponse")
